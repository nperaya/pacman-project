...
const float fullmovement = 0.4;
const float player_speed = fullmovement * 0.4;
const float player_fright = 0.2;
//000
extern float ghost_speed;
const float ghost_fright = 0.1;


const float reg_speed = 0.1;
